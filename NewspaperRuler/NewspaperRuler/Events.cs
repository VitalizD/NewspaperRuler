    ...
    public partial class Stats
    {
        private List<Note> CreateNotes()
        {
            ...
            switch (LevelNumber)
            {
                ...
                case 8:
                    {
                        var text = "\tДобрый день! Вам пишет представитель из Министерства культуры." +
                            ...
                            $"если газета не скрывает от них правдивые факты. А потому предлагаю выгодное предложение: наберите {requiredLoyality} ОЧКОВ ЛОЯЛЬНОСТИ ГРАЖДАН, и я" +
